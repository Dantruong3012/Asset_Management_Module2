...
public class updatePrices {
    ...
    public void updateMarketPrice() {
        ...
        String updatedDetail = String.format(
                "Update Time [%s] | Asset Code: %s | Last Market Price: %f | New Market Price %f | Price Fluctuations: %.2f ",
                upDatedTime.toString(), assetToUpdate.getSymBol(), currentPrice, newMarketPrice, priceFluctuations);
